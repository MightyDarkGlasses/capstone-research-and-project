...
!(function () {
                ...
                for (
                    ...
                    6 > e
                        ...
                        : 8 > e
                            ...
                            : (this.modules[this.moduleCount - 15 + e][8] =
                                g);
                }
                for (var e = 0; 15 > e; e++) {
                    var g = !a && 1 == (1 & (d >> e));
        ...
        f = {
            ...
            getBCHTypeInfo: function (a) {
                for (
                    ...
                    b ^=
                        f.G15 <<
                        (f.getBCHDigit(b) - f.getBCHDigit(f.G15));
            ...
            getBCHTypeNumber: function (a) {
                for (
                    ...
                    b ^=
                        f.G18 <<
                        (f.getBCHDigit(b) - f.getBCHDigit(f.G18));
                return (a << 12) | b;
            },
            ...
            getLostPoint: function (a) {
                for (
                    var b = a.getModuleCount(), c = 0, d = 0;
                    b > d;
                    d++
                )
                    for (var e = 0; b > e; e++) {
    ...
    (i.prototype = {
        ...
        multiply: function (a) {
            for (
                var b = new Array(this.getLength() + a.getLength() - 1),
                c = 0;
                c < this.getLength();
                c++
            )
                for (var d = 0; d < a.getLength(); d++)
                    b[c + d] ^= g.gexp(
                        g.glog(this.get(c)) + g.glog(a.get(d))
                    );
            return new i(b, 0);
        },
        mod: function (a) {
